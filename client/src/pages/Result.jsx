  ...
  return (
    ...
    <div>
        ...
        <div className='relative'>
          ...
          <span className={`absolute bottom-0 left-0 h-1 bg-blue-500 $ {loading ? 'w-full trabsition-all duration-[10s]':'w-0'}`}/>
        </div>
        <p className={!loading? 'hidden':''} >Loading...</p>
    </div>
    {!isImageLoaded &&  
    <div className='flex w-full max-w-xl bg-neutral-500 text-white text-am p-0.5 mt-10 rounded-full  '>
    ...
    <div className='flex gap-2 flex-wrap justify-center text-whote text-sm p-0.5 mt-10 rounded full'>
