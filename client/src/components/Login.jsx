...
const Login = () => {
     ...
     },[])        //scrolling will be disable using due to this section
  ...
  return (
    <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
     ...
     className='relative bg-white p-10 rounded-xl text-slate-500'>
         ...
         <p className='text-sm'> <span className='text-neutral-700 '>Welcom back!</span> Please sign in to continue.</p>
       ...
       : <p className='mt-5 text-center'>Already have an account?<span className='text-blue-600 cursor-pointer' onClick={()=>setState('Login')}>Login</span></p>    //from login to sinup N vice versa the section will be changed.
